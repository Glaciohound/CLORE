...
class ProgramExecutor(nn.Module):
    ...
    def forward(self, inputs, program):
        ...
        program_templates = torch.LongTensor(
            [
                [0, 4, 4, 4, 4, 4, 4, 4, 4],
                [0, 0, 1, 4, 4, 4, 4, 4, 4],
                [0, 0, 1, 0, 1, 4, 4, 4, 4],
        ...
        program_template_query[2, 0, :, 0] = 1000
        program_template_query[4, 0, :, 2] = 1000
        program_template_query[6, 0, :, 4] = 1000
        program_template_query[8, 0, :, 6] = 1000
